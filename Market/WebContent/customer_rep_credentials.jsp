...
<html>
	...
	<body>
		<% {
			...
			ResultSet rs;
		    rs = stmt.executeQuery("select * from customer_rep where rep_email='" + entity + "' and password='" + pass + "'");
		
			if (rs.next()) {
        		session.setAttribute("user", entity); // the username will be stored in the session
        		out.println("Welcome " + entity + "!!!");
        		out.println("<a href='logout.jsp'>Log out</a>");
        		response.sendRedirect("customer_rep_welcome.jsp");
    		} else {
        		out.println("Invalid password <a href='customer_rep_login.jsp'>try again</a>");
    		}
		} %>
